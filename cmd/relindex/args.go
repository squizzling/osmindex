...
type Opts struct {
	...
	WayIndex   string `short:"x" long:"way-index"   description:"Input WAYIDX file"  required:"true"`
	OutputFile string `short:"o" long:"output-file" description:"Output RELIDX file" required:"true"`
	Workers    int    `short:"w" long:"workers"     description:"Number of workers"                 `
	// TODO: Make this memory usage based
	Passes int `       short:"p" long:"passes"      description:"Number of passes"    default:"1"   `
