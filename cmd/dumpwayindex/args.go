...
type Opts struct {
	InputFile      string `short:"i" long:"input-file"      description:"Input IDX file" required:"true"`
	...
	SubIndexIndex  *int   `          long:"sub-index-index" description:"Zero based"`
	SubIndexCount  *int   `          long:"sub-index-count"`
	system.SystemOpts
}
